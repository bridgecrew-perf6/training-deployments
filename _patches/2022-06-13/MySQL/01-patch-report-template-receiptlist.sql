...
VALUES ('receiptlist', 'Receipt List', 'reports/treasury', 'receiptlist', NULL, NULL, '1', 'SELECT objid, receiptno, receiptdate, paidby, amount,\nCONCAT( ''qrcode:'', receiptno ) AS qrcode\n FROM cashreceipt LIMIT 50', NULL, '[]', 'SQL', 'DRAFT', NULL, '[]')
;
